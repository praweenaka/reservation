...
if ($_GET["Command"] == "getdt") {
    ...
    $sql = "select * from approve_by order by name desc";
...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from approve_by where name = '" . $_GET['nameTxt'] . "'";
...
//        if ($row['user_name'] == $_GET['nameTxt']) {
        $sql = "Insert into approve_by (name,mail,department)values 
...
//    $sql = "update approve_by set panalti_type = '" . $_GET['panalti_type'] . "',amount = '" . $_GET['amount'] . "'  where code = '" . $_GET['code'] . "'";
//    $result = $conn->query($sql);
//}
