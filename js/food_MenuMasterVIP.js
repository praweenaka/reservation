...
function newent() {
    ...
    document.getElementById('menuCombo').value = "MENU1";
...
function getdt() {
    ...
    var url = "food_MenuMasterVIP_data.php";
...
function save_inv() {
    ...
    if (document.getElementById('menuCombo').value == "") {
...
//    }
    ...
    url = url + "&menucombo=" + document.getElementById('menuCombo').value;
//    url = url + "&qty=" + document.getElementById('qtyTxt').value;
