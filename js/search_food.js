...
function getbycode(cdata) {
    ...
    url = url + "&txt_aircode=" + document.getElementById('codeText').value;

    url = url + "&txt_airname=" + document.getElementById('nameText').value;
    url = url + "&txt_country=" + document.getElementById('addressText').value;
    url = url + "&txt_town=" + document.getElementById('telephoneText').value;
    url = url + "&txt_other=" + document.getElementById('emailText').value;
    url = url + "&txt_other=" + document.getElementById('nic').value;
...
function assign_data() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_amount");
...
function update_cust_list(stname)
{
    ...
    if (document.getElementById('cusno').value != "") {
        ...
        url = url + "&mstatus=customername";
    } else if (document.getElementById('customernic').value != "") {
        url = url + "&mstatus=customernic";
    }

    url = url + "&cusno=" + document.getElementById('cusno').value;
    url = url + "&customername=" + document.getElementById('customername').value;
    url = url + "&customernic=" + document.getElementById('customernic').value;
    url = url + "&stname=" + stname;
