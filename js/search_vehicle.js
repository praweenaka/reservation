...
function custno(code)
{
    ...
    var url = "search_vehicle_data.php";
...
//        opener.document.form1.vehicleBrandTxt.value = XMLAddress1[0].childNodes[0].nodeValue;
//
//        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_type");
//        opener.document.form1.departCombo.value = XMLAddress1[0].childNodes[0].nodeValue;
//
//        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_rate");
//        opener.document.form1.chassinoTxt.value = XMLAddress1[0].childNodes[0].nodeValue;
//        
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_rate");
