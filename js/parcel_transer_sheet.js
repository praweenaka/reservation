...
function add_tmp() {
    ...
    var url = "Parcel_Transer_Sheet_Data.php";
...
function save_inv() {
    ...
    if (document.getElementById('itTxt').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Item No Not Selected</span></div>";
        return false;
    }
    ...
    for (var i = 0, f; f = files[i]; i++) {
        ...
        var itno = document.getElementById('itTxt').value;
