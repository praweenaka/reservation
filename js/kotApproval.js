...
function view()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        window.open('approve_kotEntry').document.form1.noOfVisitorTxt.value = XMLAddress1[0].childNodes[0].nodeValue;
