...
<section class="content">
    <div class="box box-primary col-lg-12">
        ...
        <div class="box-header with-border">
            <h3 class="box-title"><b>Reservation REPORTS</b></h3>
        </div>

        <form role="form" name ='form1' action="report_reservation.php" target="_blank" method="GET" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="radio">
                    <label>
                        <input type="radio" name="optionsRadios" id="kotentry" value="preservations">
                ...
                <div class="radio">
                    <label>
                        <input type="radio" name="optionsRadios" id="kotentry" value="creservations">
                ...
                <div class="radio">
                    <label>
                        <input type="radio" name="optionsRadios" id="kotentrycancel" value="cancelreservations">
