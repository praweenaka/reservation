...
if ($_GET["Command"] == "select_permission") {
    ...
    $ResponseXML .= " <tr>
      ...
      <th scope=\"col\"><input type=\"text\"  class=\"label_purchase hidden\" value=\"Feed\" disabled=\"disabled\"/></th>
      <th scope=\"col\"><input type=\"text\"  class=\"label_purchase hidden\" value=\"Delete\" disabled=\"disabled\"/></th>
      <th scope=\"col\"><input type=\"text\"  class=\"label_purchase hidden\" value=\"SP Permission\" disabled=\"disabled\"/></th>
    ...
    while ($row1 = mysqli_fetch_array($result1)) {
        ...
        if ($row = mysqli_fetch_array($result)) {
            ...
            if ($row["doc_feed"] == 1) {
                $ResponseXML .= "<td align=\"center\"><input type=\"checkbox\" class=\"hidden\" name=\"" . $chkfeed . "\" id=\"" . $chkfeed . "\" checked=\"checked\"/></td>";
            } else {
                $ResponseXML .= "<td align=\"center\"><input type=\"checkbox\" class=\"hidden\" name=\"" . $chkfeed . "\" id=\"" . $chkfeed . "\" /></td>";
            }

            if ($row["doc_mod"] == 1) {
                $ResponseXML .= "<td align=\"center\"><input type=\"checkbox\" class=\"hidden\" name=\"" . $chkmod . "\" id=\"" . $chkmod . "\"checked=\"checked\" /></td>";
            } else {
                $ResponseXML .= "<td align=\"center\"><input type=\"checkbox\" class=\"hidden\" name=\"" . $chkmod . "\" id=\"" . $chkmod . "\" /></td>";
            }
            if ($row["price_edit"] == 1) {
                $ResponseXML .= "<td align=\"center\"><input type=\"checkbox\" class=\"hidden\" name=\"" . $chkprice . "\" id=\"" . $chkprice . "\" checked=\"checked\"/></td>";
            } else {
                $ResponseXML .= "<td align=\"center\"><input type=\"checkbox\" class=\"hidden\" name=\"" . $chkprice . "\" id=\"" . $chkprice . "\" /></td>";
            }
